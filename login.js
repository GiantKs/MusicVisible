...
var endtype=getUrlParams('endtype',newurl);
var clientversion=getUrlParams('clientversion',newurl);
var companyid=getUrlParams('companyid',newurl);
var companydomain=getUrlParams('companydomain',newurl);
var number='';
document.documentElement.style.fontSize = ( (document.documentElement.clientWidth || document.body.clientWidth) / (1220/ 100) ) + "px";

//=========2018,2,28=====================
if(!endtype && !clientversion){   // 不是客户端的情况下
    companydomain = 'xxwjy';
    body.className = 'Browser';
    document.documentElement.style.fontSize = ( (document.documentElement.clientWidth || document.body.clientWidth) / (1220/ 100) *0.28)+ "px";
    body.style.height= main.scrollHeight > (document.documentElement.clientHeight || document.body.clientHeight)?main.scrollHeight+'px':'100%';
...
if(languageName==='chinese'){
    ...
    if(getUrlParams('result')=='3'){
        ...
        hint.innerText= '课程开始前10分钟允许进入，请等候!';
        hint.style.display='block';
        button.style.opacity='0.5';
        button.classList.remove('btn');
    }
    ...
    userphone.onkeyup=function (e) {
        if(password.value&&userphone.value){
            hint.innerText= '';
    ...
    if(getUrlParams('result')=='3'){
        ...
        hint.innerText= '10 minutes before the start of the course, please wait!';
        hint.style.display='block';
        button.style.opacity='0.5';
        button.classList.remove('btn');
    }
