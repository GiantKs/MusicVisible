...
const TkConstant = {} ;
/*版本号*/
let VERSIONS  =  'v2.1.6.1' , VERSIONSTIME = '2018013018' ,  DEV = false ;
try{
...
TkConstant.remoteNewpptUpdateTime = 201801181028 ; //远程动态PPT文件更新时间
...
Object.defineProperties(RoomEvent, {
    ...
    roomCilentClose:{//room-cilent-_close：服务器回放的播放时间更新
        value: 'room-cilent-close',
        writable: false,
        enumerable: true,
    },
...
TkConstant.bindServiceinfoToTkConstant = (protocol , hostname , port , isInit=true )=>{
    ...
    let serviceinfo = {
        ...
        hostname:hostname ,
        port:port,
        sdkPort:TkGlobal.isBroadcast && !TkGlobal.isClient?port:443 ,
...
let broadcastFileListAccpetArr = ['mp4'] ; //直播电影文件类型数组 //xgd 2017-12-06
TkConstant.FILETYPE = {
    ...
    broadcastFileListAccpetArr:broadcastFileListAccpetArr ,
    ...
    broadcastFileListAccpet:"."+broadcastFileListAccpetArr.join(',.') ,
};
...
/*绑定房间信息到TkConstant*/
TkConstant.joinRoomInfo = undefined ;
...
Object.defineProperties(TkConstant.streamFailureType  , {//failuretype = 1 udp不通 2 publishvideo失败（除去人数超限） 3 人数超限 4 home键了 5 udp中途断掉
    udpNotOnceSuccess: {
        value: 1 ,
        writable: false,
    },
