...
class TopVesselSmart extends React.Component{
    ...
    componentDidUpdate( prevProps,  prevState ){
        if(this.props.bottomVesselSmartHeightRem !== prevProps.bottomVesselSmartHeightRem){
            ...
            eventObjectDefine.CoreController.dispatchEvent({type:"changeBottomVesselSmartHeightRem" , message:{bottomVesselSmartHeightRem:this.props.bottomVesselSmartHeightRem}});
        }
    }
