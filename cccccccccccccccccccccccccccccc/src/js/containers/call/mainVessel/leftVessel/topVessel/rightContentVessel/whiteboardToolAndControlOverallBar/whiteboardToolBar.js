...

                        {
                            !brush?undefined: (
                                <li className={"tool-li tl-pencil " +(currentExtendToolContainer === 'whiteboard_tool_vessel_brush'?'active ':' ') +(currentExtendToolContainer === 'whiteboard_tool_vessel_brush' && showCurrentExtendToolContainer ?'more ':' ')   } id="whiteboard_tool_vessel_brush"  onMouseLeave={that.allLiMouseLeave.bind(that  , 'whiteboard_tool_vessel_brush') }   style={{display:!brush?'none':undefined }}  >
                                    <button  className={"header-tool tool-pencil  tool-more " }   id="tool_vessel_brush"  title={TkGlobal.language.languageData.header.tool.pencil.title}    onClick={that.selectExtendTool.bind(that  ,  {extendToolId:'whiteboard_tool_vessel_brush'} ) }   data-iconclass={useBrush} >
                                        <span className="tool-img-wrap tool-pencil-icon" ></span>
                                    </button>
                                    <div className="header-tool-extend tool-pencil-extend" style={{right:(pagingToolLeft>1.45|| pagingToolLeft==false?'100%':undefined),left:(pagingToolLeft<1.4  && typeof(pagingToolLeft)=="number"?'100%':undefined)}}>{/*tkpc2.0.8*/}
                            ...
                            !text?undefined: (
                                TK.SDKTYPE !== 'mobile'? (
                                    <li  className={"tool-li tl-text " +(currentExtendToolContainer === 'whiteboard_tool_vessel_text'?'active ':' ') +(currentExtendToolContainer === 'whiteboard_tool_vessel_text' && showCurrentExtendToolContainer ?'more ':' ')  }   id="whiteboard_tool_vessel_text"  onMouseLeave={that.allLiMouseLeave.bind(that  , 'whiteboard_tool_vessel_text') }   style={{display:!text?'none':undefined }}  >
                                        <button className="header-tool  tool-text  tool-more"   title={TkGlobal.language.languageData.header.tool.text.title}  id="tool_text"   onClick={that.selectExtendTool.bind(that  ,  {extendToolId:'whiteboard_tool_vessel_text'} ) }    data-iconclass={useText} >
                                            <span className="tool-img-wrap"></span>
                                        </button>
                                        <div className="header-tool-extend tool-text-extend" id="tool_text_extend" style={{right:(pagingToolLeft>1.45|| pagingToolLeft==false?'100%':undefined),left:(pagingToolLeft<1.4  && typeof(pagingToolLeft)=="number"?'100%':undefined)}}>{/*tkpc2.0.8*/}
                                            <ul className="clear-float">
...

                        {
                            !shape?undefined: (
                                <li  className={"tool-li tl-shape "  +(currentExtendToolContainer === 'whiteboard_tool_vessel_shape'?'active ':' ') +(currentExtendToolContainer === 'whiteboard_tool_vessel_shape' && showCurrentExtendToolContainer ?'more ':' ')  }    id="whiteboard_tool_vessel_shape"   onMouseLeave={that.allLiMouseLeave.bind(that  , 'whiteboard_tool_vessel_shape') }   style={{display:!shape?'none':undefined }}  >
                                    <button className="header-tool  tool-shape   tool-more"   title={TkGlobal.language.languageData.header.tool.shape.title}  id="tool_shape_list"  onClick={that.selectExtendTool.bind(that  ,  {extendToolId:'whiteboard_tool_vessel_shape'} ) }   data-iconclass={useShape} >
                                        <span className="tool-img-wrap"></span>
                                    </button>
                                    <div className="header-tool-extend tool-shape-extend" style={{right:(pagingToolLeft >1.45|| pagingToolLeft==false?'100%':undefined),left:(pagingToolLeft<1.4  && typeof(pagingToolLeft)=="number"?'100%':undefined)}}>{/*tkpc2.0.8*/}
                                        <ul className="clear-float">
...

                        {
                            !colorAndSize?undefined: (
                                ...
                                <span id="tool_stroke_color"  className="tool-img-wrap h-tool-color no-hover">
                                    ...
                                    <div className="header-tool-extend tool-color-extend clear-float tk-tool-color-extend" style={{right:(pagingToolLeft >1.45|| pagingToolLeft==false?'100%':undefined),left:(pagingToolLeft<1.4  && typeof(pagingToolLeft)=="number"?'100%':undefined)}}>{/*tkpc2.0.8*/}
