...
class AnswerTeachingToolSmart extends React.Component {
    ...
    render(){
        ...
        // tkpc2.0.8   <span className="publish-the-answer"...暂时不需要公布答案的，暂时隐去
        let answerDragStyle = {
            position: 'absolute',
            zIndex: 110,
				...
				<div  className="result-teach-wrapDiv" style={{display:this.state.resultTeachDisplay}} ref="resultRef">
					...
					<div className="result-teach-content">
						...
						<div className="result-teach-true-result">
							...
							<span className="publish-the-answer" onClick={this.publishAnswerHandel.bind(this)} style={{background:this.state.publishedWarningColor,display:"none"}}>{this.state.publishAnswerText}</span>
						</div>
