...
class HandlerIframeMessage{
    ...
    addEventListener(){
        ...
        eventObjectDefine.CoreController.addEventListener("outIframe-msglist" ,that.handlerRoomMsglist.bind(that)  ,  that.listernerBackupid );
    };
    ...
    handlerRoomMsglist(receiveData) {
        if (window == window.parent) {return ;};//如果页面没有被iframe包裹,则return
