...
const ServiceTooltip = {
    ...
    showInputTooltip: function(data, callback){
        ...
        data.bottom = data.bottom ? data.bottom : {
            button: [{
                name: 'confirm',
                text: TkGlobal.language.languageData.notice.publish  //TODO  需要去语言包里更改并复用全局常量中的语言包数据
            },{
                name: 'cancel',
                text: TkGlobal.language.languageData.notice.cancel  //TODO  需要去语言包里更改并复用全局常量中的语言包数据
            }]
        };
