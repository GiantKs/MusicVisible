...
class TimerTeachingToolSmart extends React.Component {
		...
		{	
			if(that.state.timerTeachToolWrapDisplay=="none"){
				...
				that.setState({timerTeachToolWrapDisplay:that.state.timerTeachToolWrapDisplay,startAndStop:that.state.startAndStop,
					...
					startAndStopImg:that.state.startAndStopImg,overBtn:that.state.overBtn})
		}
			}
	}
	/*权限*/
	...
	startBtnHandel(e) {
		...
		this.setState({
			...
			this.setState({startAndStopImg:this.state.startAndStopImg,overBtn:this.state.overBtn,startBtnStyle:this.state.startBtnStyle,againBtnStyle: this.state.againBtnStyle,triangleStyle:this.state.triangleStyle,againUnClickableStyle:this.state.againUnClickableStyle})
	...
	stopBtnHandel(){
		if(TkConstant.hasRole.roleChairman || TkConstant.hasRole.roleTeachingAssistant){
			...
			this.state.againUnClickableStyle="none";
			this.state.againBtnStyle = "block";
			this.setState({startAndStopImg:this.state.startAndStopImg,overBtn:this.state.overBtn,startBtnStyle:this.state.startBtnStyle,againBtnStyle: this.state.againBtnStyle,startAndStop:this.state.startAndStop,triangleStyle:this.state.triangleStyle,againUnClickableStyle:this.state.againUnClickableStyle})
			clearInterval(this.stop);
			let stopBtn = this.state.startAndStop;
			let iconShow=this.state.isShow;
			let dataTimerArry = this.state.timeDescArray;
		...
		return connectDragSource(
			<div id="timerDrag" style={timerDragStyle}>
                <div className="timer-teachTool-wrap" style={{display:this.state.timerTeachToolWrapDisplay}} ref='timerTeachToolWrap'>
                    ...
                    <div className="timer-teachTool-overBtn" style={{display:this.state.overBtn}} title={TkGlobal.language.languageData.timers.timerStop.text}></div>
