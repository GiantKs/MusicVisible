...
class RemoteControlDetectionDeviceSmart extends React.Component{
    ...
    handleRemoteControl_deviceManagement(recvEventData){
        ...
        this.setState({show:true , loadShowOptionJson:this.state.loadShowOptionJson , loading:true , titleText: titleText , audiooutputVolume:user.volume!==undefined?user.volume:100,changeProgress:user.volume!==undefined?user.volume:100 });
    ...
    handerVolumeOnAfterChange(volume){
        this.state.audiooutputVolume=volume
        this.state.changeProgress=volume
        this.setState({
            audiooutputVolume:this.state.audiooutputVolume,
            changeProgress:this.state.changeProgress
        });
    };
    ...
    render(){
        let that = this ;
        let { show   , devicesDesc   , loading , loadShowOptionJson  , titleText,audiooutputVolume,changeProgress} = that.state ;//音量加
                        ...
                        <div className="testing-right en-testing-right">
                            ...
                            <div className="video-right fixldy" id="remote_control_skip-video" style={{ display:loadShowOptionJson.deviceManagement?'block':'none'}} >
                                <div className="video-right-inside device-right-inside">
                                    ...
                                    <div className="camera-option-all clear-float">{/*耳机音量*/}
                                        ...
                                        <div className="styled-select">
                                            <div className="sound-vol earphone-vol">
                                                ...
                                                <ReactSlider className={"tk-slide tk-detection-device"} withBars  defaultValue={100} value={changeProgress}  onBeforeChange={that.handerVolumeOnBeforeChange.bind(that)}   onAfterChange={that.handerVolumeOnAfterChange.bind(that)}    />
